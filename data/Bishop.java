...
public class Bishop extends Piece {
	...
	public static ImageIcon getImage(boolean isWhite) {
		String filename = "/images/BB.gif";
		if (isWhite) {
			filename = "/images/WB.gif";
		}

		URL url = Bishop.class.getResource(filename);
	 ...
	 * 
	 */
	public Bishop(Location loc, boolean flag) {
		initialise(loc, flag);
	...
	public void initialise(Location location, boolean isWhiteFlag) {
		...
		// Bishop can move any number of squares in 4 directions
