...
public class Rook extends Piece {
	...
	public static ImageIcon getImage(boolean isWhite) {
		String filename = "/images/BR.gif";
		if (isWhite) {
			filename = "/images/WR.gif";
		}
		URL url = Rook.class.getResource(filename);
	 ...
	 * 
	 */
	public Rook(Location loc, boolean flag) {
		initialise(loc, flag);
	...
	public void initialise(Location location, boolean isWhiteFlag) {
		...
		// Queen can move any number of squares in 4 directions
